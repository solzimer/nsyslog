...
class NSyslog extends EventEmiter {
	constructor(cfg) {
		...
		/** @property {object}  Configuration file */
		this.config = cfg;
	 ...
	 *
	 * @param {MODULE_TYPES} type {@link module:constants.MODULE_TYPES} Component type
	 * @param {string} id Component ID
	 * @param {PROC_MODE} mode {@link module:constants.PROC_MODE} Process mode
